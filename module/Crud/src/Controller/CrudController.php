...
class CrudController extends AbstractActionController
{
 ...
 // Create the form.
        ...
        $form->get('date_start')->setValue($value->getDateStart());
        $form->get('date_end')->setValue($value->getDateEnd());
        if ($this->getRequest()->isPost()) {
        $data = $this->params()->fromPost();
        $form->setData($data);
        if($form->isValid()) {             
        ...
        $edit->setDateStart($data['date_start']);
        $edit->setDateEnd($data['date_end']);
